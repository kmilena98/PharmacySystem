        ...
        <b-col sm = "3">
                <h6> Unesite jedinstveni broj rezervacije leka :</h6>
                     <b-form-group
                        ...
                        :state="state"
                        >
                        <b-form-input v-model="drugReservation" type="number" id="input-1" :state="state" trim required></b-form-input>
                    </b-form-group>
          ...
          <b-col sm = "3">
                <h6> Rezervisani lek je  :</h6>
                     <b-form-group
                        ...
                        :state="state"
                        >
                        <b-form-input  v-model="drugShow" id="input-1" :state="state" trim required disabled></b-form-input>
                    </b-form-group>
           ...
           .then(response => {
            // ako lek nije dostupan obavesti ga 
              if(response.status == 200){
                  ...
                  this.drugShow = " "+ response.data.code+" , "+response.data.name + "          Loyalty points: " + response.data.loyalityPoints
              }
            }) .catch(error => {
