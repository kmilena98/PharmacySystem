package ISA.Team54.security.config;
...
import ISA.Team54.security.auth.RestAuthenticationEntryPoint;
import ISA.Team54.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) throws Exception {
		...
		web.ignoring().antMatchers(HttpMethod.POST, "/auth/login","/pharmacy/addPharmacy","/examination/updateExamination");
	//	web.ignoring().antMatchers(HttpMethod.POST, "/auth/signup");
		//web.ignoring().antMatchers(HttpMethod.POST, );
		web.ignoring().antMatchers(HttpMethod.GET, "/", "/webjars/**", "/*.html", "/favicon.ico", "/**/*.html",
				"/**/*.css", "/**/*.js","/api/patientBySurnameAndName/*","/api/allPatients/","/examination/soonestExamination/*",
				"/examination/examinationHistory/*","/api/examinatedPatients/*","/drugs/forPatient/*","/drugs/drugSpecification/**","/drugs/isAvailableInPharmacy/**");
	}
